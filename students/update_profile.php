  ...
  <aside class="main-sidebar sidebar-light-primary elevation-4">
    ...
    <div class="sidebar">
      ...
      <nav class="mt-2">
        ...
        <li class="nav-item">
          <a href="applied_jobs.html" class="nav-link">
          ...
          <div class="card-body" style="margin-bottom: 40px;">
            <form class="col-md-10">
              ...
              <div class="form-group">
                ...
                <input type="file" class="form-control" id="profileImage" name="profileImage" accept=".jpg" accept=".png">
              </div>
              ...
              <div class="form-group">
                <label for="name">SGPA</label>
                <input type="text" class="form-control" id="sgpa" name="sgpa">
              </div>
              <div class="form-group">
                <label for="name">12th</label>
                <input type="number" class="form-control" id="sgpa" name="sgpa">
              </div>
              <div class="form-group">
                <label for="name">10th</label>
                <input type="text" class="form-control" id="sgpa" name="sgpa">
              </div>
              <div class="form-group">
