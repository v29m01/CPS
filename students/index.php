  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <a href="update_profile.php"><button type="submit" class="btn btn-primary float-right" style="background-color:#D34426 ;border:#D34426">Update Profile</button></a>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
    </div>
    ...
    <section class="content">
        <div class="container-fluid">
            ...
            <!-- View Card -->
            <div class="card-primary" style="background-color: #ffffff; margin-bottom:50px;" >
              ...
              <div class="card-body">
                ...
                <dd class="col-sm-9"><img src="../images/logo.png" alt="" srcset="" style="width: 150px;"></dd>
                  ...
                  <dt class="col-sm-3">SGPA & Year:</dt>
                  <dd class="col-sm-9">18.39[2024]</dd>
                    
                  
                  <dt class="col-sm-3">10th Percentage:</dt>
                  <dd class="col-sm-9">78.00</dd>

                  <dt class="col-sm-3">12th Percentage:</dt>
                  <dd class="col-sm-9">78.00</dd>

                  <dt class="col-sm-3">Resume:</dt>
                  <dd class="col-sm-9">
                    <a href="../dist/resume/demo.pdf" download="demo.pdf" class="btn btn-success">
                      Download Resume
                    </a>
                  </dd>
