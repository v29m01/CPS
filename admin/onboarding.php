...
if (isset($_GET['delete_id'])) {
    ...
    $deleteQuery = $con->prepare("DELETE FROM student_table WHERE student_id = :deleteId");
    $deleteQuery->bindParam(':deleteId', $deleteId);
    ...
    if ($result) {
        ...
        echo "Error deleting record: " . print_r($deleteQuery->errorInfo(), true);
    }
}

// Fetch all students data
$query = $con->query("SELECT * FROM student_table");
  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <a href="add_student.php"><button type="submit" class="btn btn-primary float-right" style="background-color:#D34426 ;border:#D34426">Add New</button></a>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
    </div>
    ...
    <section class="content">
      <div class="col-12">
        ...
        <th class="sorting sorting_asc" tabindex="0" aria-controls="example2" rowspan="1" colspan="1" aria-sort="ascending" aria-label="Rendering engine: activate to sort column descending">Profile</th>
        ...
        <th class="sorting" tabindex="0" aria-controls="example2" rowspan="1" colspan="1" aria-label="CSS grade: activate to sort column ascending">Date of Birth</th>
        ...
        <tr class="odd">
        <td class="dtr-control sorting_1" ><?php echo $student['student_id']; ?></td>
        <td class="tdad"><img src="../uploads/student_profile/<?php echo $student['profile_image']; ?>" alt="Profile" style="max-width: 50px;"></td>
        <td><?php echo $student['name']; ?></td>
        <td><?php echo $student['branch']; ?></td>
        <td><?php echo $student['phone']; ?></td>
        <td><?php echo $student['date_of_birth']; ?></td>
        <td><?php echo $student['email']; ?></td>
        <td><a href="view_student.php?id=<?php echo $student['id']; ?>"><button type="submit" class="btn btn-primary">View</button></a>
          <a href="edit_student.php"><button type="submit" class="btn btn-success">Edit</button></a>
          <a href="?delete_id=<?php echo $student['student_id']; ?>" onclick="return confirm('Are you sure you want to delete this record?')"><button type="submit" class="btn btn-danger">Delete</button></a>
        </td>
        </tr>
        <?php endforeach; ?>
      </tbody>
        <tfoot>
          <tr><th class="sorting sorting_asc" tabindex="0" aria-controls="example2" rowspan="1" colspan="1" aria-sort="ascending" aria-label="Rendering engine: activate to sort column descending">Id</th>
            <th class="sorting sorting_asc" tabindex="0" aria-controls="example2" rowspan="1" colspan="1" aria-sort="ascending" aria-label="Rendering engine: activate to sort column descending">Profile</th>
            <th class="sorting" tabindex="0" aria-controls="example2" rowspan="1" colspan="1" aria-label="Browser: activate to sort column ascending">Name</th>
            <th class="sorting" tabindex="0" aria-controls="example2" rowspan="1" colspan="1" aria-label="Platform(s): activate to sort column ascending">Branch</th>
            <th class="sorting" tabindex="0" aria-controls="example2" rowspan="1" colspan="1" aria-label="Engine version: activate to sort column ascending">Phone</th>
