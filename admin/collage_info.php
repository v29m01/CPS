...
<head>
  ...
  <title>RDTC | Collage Information</title>
  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h3 class="m-0">About Institute</h3>
          </div><!-- /.col -->
          <div class="col-sm-6">
      ...
      <div class="container-fluid">
        ...
        <div class="card-primary" style="background-color: #ffffff;">
          <div class="card-header" style="background-color: #D34426;">
            <h3 class="card-title">Collage Information</h3>
            </div>
          <div class="card-body" style="margin-bottom: 40px;">
            <form class="col-md-10">
              ...
              <div class="form-group">
                ...
                <input type="textarea" class="form-control" id="courses" name="courses">
              </div>
