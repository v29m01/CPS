  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <a href="add_company.php"><button type="submit" class="btn btn-primary float-right" style="background-color:#D34426 ;border:#D34426">Add New</button></a>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
    </div>
    ...
    <section class="content">
      <div class="col-12">
        ...
        <td>A</td>
        <td>A</td>
        <td><a href="view_company.php"><button type="submit" class="btn btn-primary">View</button></a>
          <a href="edit_company.php"><button type="submit" class="btn btn-success">Edit</button></a>
