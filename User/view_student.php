...
<div class="wrapper">
  ...
  <aside class="main-sidebar sidebar-light-primary elevation-4">
    <!-- Brand Logo -->
    <a href="../admin/index.html" class="brand-link" style="color: #F37F13;" >
    ...
    <div class="sidebar">
     ...
     <nav class="mt-2">
      ...
      <li class="nav-item">
          <a href="drives.html" class="nav-link">
            <i class="nav-icon fas fa-table"></i>
            <p>Drives</p>
          </a>
      </li>
      <li class="nav-item">
          <a href="selected_students.html" class="nav-link">
      ...
      <li class="nav-item">
          <a href="change_pass.html" class="nav-link">
